  ...
  return (
    ...
    >
        ...
        <div className="flex flex-wrap gap-3">
          {categories.map((cat, index) => (
            <button
              ...
              className={`px-4 py-2 rounded-xl text-sm font-medium shadow-sm transition-all duration-200 hover:scale-105 ${selectedCategories.includes(cat.id)
              ...
              product.images.map((img, index) => (
                ...
                >
                  ...
                  <button
                    ...
                    className={`absolute -top-2 -right-2 text-white text-xs px-2 py-1 rounded-lg shadow-lg font-semibold transition-all duration-200 hover:scale-110 flex items-center gap-1 ${deleteImages.includes(img.id)
      ...
      <div className="space-y-4">
        ...
        {/* Drag & Drop Zone */}
        <div
          className={`relative border-2 border-dashed rounded-xl p-8 transition-all duration-300 cursor-pointer group ${dragActive
        ...
        >
          ...
          <div className="text-center">
            <div className={`w-16 h-16 mx-auto mb-4 rounded-full flex items-center justify-center transition-all duration-300 ${dragActive
            ...
            <div className="space-y-2">
              <p
                className={`text-lg font-medium transition-colors duration-300 ${dragActive
                    ? "text-green-600 dark:text-green-400"
                    : "text-gray-700 dark:text-gray-300"
                  }`}
              >
                {dragActive ? t("soltar") : t("arrastrar")}
              </p>
              <p className="text-sm text-gray-500 dark:text-gray-400">
                o <span className="text-green-600 dark:text-green-400 font-medium">{t("oHazClick")}</span>
              </p>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 border border-blue-200 dark:border-blue-800">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="text-sm font-semibold text-blue-800 dark:text-blue-300">
                {t("nuevasImagenes")} ({newImages.length})
              </h4>
            </div>
